...
function xa(e,t,n){B(Ea,t._currentValue),t._currentValue=n}function Oa(e){e._currentValue=Ea.current,U(Ea)}function Pa(e,t,n){for(;null!==e;){var r=e.alternate
...
function jo(e,t){B(To,e=Ec),B(Co,t),Ec=e|t.baseLanes}function No(){B(To,Ec),B(Co,Co.current)}function zo(){Ec=To.current,U(Co),U(To)}var Ao=I(null),Lo=null
...
else{if(0!==kc||null!==e&&128&e.flags)for(e=t.child;null!==e;){if(null!==(o=Bo(e))){for(t.flags|=128,fu(r,!1),e=o.updateQueue,t.updateQueue=e,su(t,e),t.subtreeFlags=0,e=n,n=t.child;null!==n;)Br(n,e),n=n.sibling
...
for(d in r)p=r[d],m=n[d],!r.hasOwnProperty(d)||p===m||null==p&&null==m||ff(e,t,d,p,r,m)}(r,e.type,n,t),r[Ge]=t}catch(t){ks(e,e.return,t)}}function _u(e){return 5===e.tag||3===e.tag||26===e.tag||27===e.tag&&Pf(e.type)||4===e.tag}function xu(e){e:for(;;){for(;null===e.sibling;){if(null===e.return||_u(e.return))return null
...
pf(t,r,n),t[Be]=e,t[Ge]=n}catch(t){ks(e,e.return,t)}}var Tu=!1,ju=!1,Nu=!1,zu="function"==typeof WeakSet?WeakSet:Set,Au=null
...
try{Vd(e)}catch(e){ks(t,t.return,e)}}}function Bu(e,t){if(null===t.memoizedState&&(null!==(e=t.alternate)&&(null!==(e=e.memoizedState)&&null!==(e=e.dehydrated))))try{Vd(e)}catch(e){ks(t,t.return,e)}}function Gu(e,t){var n=function(e){switch(e.tag){case 31:case 13:case 19:var t=e.stateNode
...
case 3:if(nd=null,a=Hu,Hu=Gf(t.containerInfo),$u(t,e),Hu=a,Wu(e),4&r&&null!==n&&n.memoizedState.isDehydrated)try{Vd(t.containerInfo)}catch(t){ks(e,e.return,t)}Nu&&(Nu=!1,qu(e))
break
...
break
case 5:il(t)
default:hu(n,t),t=lu(n,t=hc=Br(t,Ec),Ec)}e.memoizedProps=e.pendingProps,null===t?ps(e):hc=t}function ds(e,t,n,r){_a=ka=null,il(t),io=null,uo=0
var a=t.return
...
case 8:a=Ed
break
default:a=kd}n=a.bind(null,t,n,e),a=void 0,!Gt||"touchstart"!==t&&"touchmove"!==t&&"wheel"!==t||(a=!0),r?void 0!==a?e.addEventListener(t,n,{capture:!0,passive:a}):e.addEventListener(t,n,!0):void 0!==a?e.addEventListener(t,n,{passive:a}):e.addEventListener(t,n,!1)}function tf(e,t,n,r,a){var o=r
...
if(!e.modified_){const r=Ee(ne(e),t),l=r?.[G]
...
var Sn,En
function kn(e){let t=o.useRef(mn(e)),n=o.useRef(!1),r=Bt(),a=o.useMemo(()=>function(e,t){let n=mn(e)
...
var m=(s||[]).map(function(e){return o.createElement("div",{key:e.id,className:"board-column"},o.createElement("div",null,o.createElement("b",null,e.title),o.createElement("br",null),o.createElement(wn,{to:"/boards/edit_column/"+e.id,className:"nav-btn"},"Edit Column")),o.createElement("div",null,o.createElement(Na,{columnid:e.id,ticketData:d[e.id]})))})
return o.createElement("div",null,o.createElement("h2",null,"View Board Columns with Tickets"),o.createElement("div",{className:"project-div"},o.createElement("b",null,"Project [",i&&i.id,"] "),o.createElement("br",null),o.createElement(wn,{to:"/projects/edit/"+(i?i.id:""),className:"nav-btn"},"Edit Project"),o.createElement("br",null),i&&i.title,o.createElement("br",null),i&&i.description),o.createElement("div",{className:"board-div"},o.createElement("b",null,"Board Title:")," ",r&&r.title," [",r&&r.id,"]",o.createElement("br",null),o.createElement(wn,{to:"/boards/edit/"+(r?r.id:""),className:"nav-btn"},"Edit Board")),o.createElement("div",{className:"board-columns"},m))}function Na(e){var t=e.columnid,n=(e.ticketData||[]).map(function(e){return o.createElement("div",{key:e.id,className:"column-ticket"},o.createElement("div",null,o.createElement("b",null,"Title:")," ",e.title),o.createElement("div",null,o.createElement(wn,{to:"/tickets/view/"+e.id,className:"nav-btn"},"View Ticket")))})
...
return o.createElement("div",null,o.createElement(Kn,{projectid:e}))},Ba=function(){var e=Vt().projectid
return o.createElement("div",null,o.createElement(Gn,{projectid:e}))},Ga=function(){return o.createElement("div",null,o.createElement("h2",null,"Boards"),o.createElement(ln,null))},$a=function(){return o.createElement("div",null,o.createElement(lr,null))},Ha=function(){var e=Vt().projectid
...
return o.createElement("div",null,o.createElement(Gr,{boardid:e}))},Ja=function(){var e=Vt().ticketid
